...
using Sofisoft.Accounts.Security.API.Infrastructure.AutofacModules;
...
namespace Sofisoft.Accounts.Security.API
{
    public class Startup
    {
        ...
        {
            services.Configure<SecuritySetting>(Configuration);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger()
                .UseSwaggerUI(c =>
                    {
                        c.DocumentTitle = "Sofisoft - SecurityAPI";
